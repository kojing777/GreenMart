...
const InputField = ({type, placeholder,name,handleChange,address}) => (
  <input className="w-full px-2 py-2.5 border border-gray-500/30 rounded outline-none text-gray-500 focus:border-primary transition " type={type} 
...
<form onSubmit={onSubmitHandler} className="space-y-3 mt-6 text-sm">
  ...
  <button className="w-full mt-6 bg-primary text-white py-3 rounded-md hover:bg-primary-dull transition cursor-pointer uppercase" type="submit">
    Save Address
  </button>
</form>
</div>
